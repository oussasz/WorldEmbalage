...
class DocumentService:
    ...
    def build_delivery_note(self, reference: str, client_name: str, delivery_date: date, lines: list[dict]) -> Path:
        return build_delivery_note_pdf(reference, client_name, delivery_date, lines)
