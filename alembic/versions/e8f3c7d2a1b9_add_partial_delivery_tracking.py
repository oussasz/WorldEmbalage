...
def upgrade() -> None:
    ...
    # Create indexes
    op.create_index('ix_material_deliveries_supplier_order_line_item_id', 'material_deliveries', ['supplier_order_line_item_id'])
    op.create_index('ix_material_deliveries_delivery_date', 'material_deliveries', ['delivery_date'])
